...
builder.Services.AddScoped<ConsultarPagadorPlugBankUseCase>();
builder.Services.AddScoped<ListarPagadoresPlugBankUseCase>();
builder.Services.AddScoped<AtualizarPagadorUseCase>();
builder.Services.AddScoped<DesativarPagadorUseCase>();
